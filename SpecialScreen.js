  ...
  const buildPrintHTML = (copies, phaseKey=null) => {
    ...
    const buildCasesTable = (orders) => {
      ...
      return `<table style="table-layout:fixed;width:100%"><colgroup>
        <col style="width:55px"><col style="width:125px"><col style="width:35px"><col style="width:28px"><col style="width:130px"><col style="width:28px"><col style="width:70px"><col style="width:160px"><col>
      </colgroup><thead><tr>
