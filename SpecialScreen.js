  ...
  const buildPrintHTML = (copies, phaseKey=null) => {
    ...
    const buildCasesTable = (orders) => {
      ...
      return `<table style="table-layout:fixed;width:100%"><colgroup>
        <col style="width:55px"><col style="width:125px"><col style="width:35px"><col style="width:28px"><col style="width:130px"><col style="width:28px"><col style="width:80px"><col><col style="width:65px">
      </colgroup><thead><tr>
